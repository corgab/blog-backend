        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="form-floating mb-4">
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $post->title) }}" placeholder="Scrivi il titolo qui" required>
                ...
                <div class="row">
                    <div class="col row row-cols-2">
                        ...
                        <div class="form-check">
                            <input @checked($post->tags->contains($tag->id)) class="form-check-input @error('tag_id') is-invalid @enderror" name="tag_id[]" type="checkbox" value="{{ $tag->id }}" id="tag-{{ $tag->id }}">
