...
<div class="container py-4">
    <h1 class="text-center mb-4">Creazione Post</h1>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check">
                            <input @checked(in_array($tag->id, old('tag_id', []))) class="form-check-input @error('tag_id') is-invalid @enderror" name="tag_id[]" type="checkbox" value="{{ $tag->id }}" id="tag-{{ $tag->id }}">
